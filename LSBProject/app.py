...
# ------ ملفات محمية من الحذف ------
IMMUNE_FILES = {'encrypted_demo.png'}

# ------ وظيفة الحذف التلقائي ------
def delete_old_files():
    """حذف الملفات القديمة كل 24 ساعة، مع استثناء ملفات محددة."""
    while True:
        try:
            ...
            for folder in folders:
                ...
                for filename in os.listdir(folder):
                    # استثناء الملفات المحمية
                    if filename in IMMUNE_FILES:
                        continue
                    
                    file_path = os.path.join(folder, filename)
                    
                    # تجاهل الملفات النظامية أو المجلدات
        ...
        time.sleep(3600)  # إعادة التحقق كل ساعة
