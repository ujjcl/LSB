...
| Issue                                     | Solution                                                              |
|-------------------------------------------|-----------------------------------------------------------------------|
|> **Note:** This issue has been resolved in version 2.5. The key generation process has been updated to automatically produce a valid 44-character Base64 key, eliminating the need for manual regeneration. Key contains invalid characters (e.g., '_' or '-') | Regenerate the key until a valid 44-character Base64 key is obtained, Refresh until you get a valid key like: ```tyIKetCBoITu82wJ4rN3ryzIWlKvB3EMcRC38jYVKbM=  ``` |
